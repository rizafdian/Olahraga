      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           <div class="row">
            <div class="col-lg-4">
             <form role="form" method="POST" action="<?php echo base_url()."index.php/c_admin/do_insert_cb_olahraga"; ?>">
                <div class="form-group">
                  <label>Kode Cabang Olahraga</label>
                  <input class="form-control" name="kd_cb_olahraga" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Nama Cabang Olahraga</label>
                  <input class="form-control" name="nm_cb_olahraga" placeholder="Enter text">
                </div>
