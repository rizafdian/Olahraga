      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           <div class="row">
            <div class="col-lg-4">
             <form role="form" method="POST" action="<?php echo base_url()."index.php/c_admin/do_insert_pelatih"; ?>">
                <div class="form-group">
                  <label>Id Pelatih</label>
                  <input class="form-control" name="id" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Nama</label>
                  <input class="form-control" name="nm_pelatih" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Tempat Lahir</label>
                  <input class="form-control" name="tmpt_lhr" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Tanggal Lahir</label>
                  <input class="form-control" name="tgl_lhr" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Alamat</label>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="username_pelatih" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <input class="form-control" name="password_pelatih" placeholder="Enter text">
                </div>
