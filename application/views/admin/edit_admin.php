      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           <div class="row">
            <div class="col-lg-4">
             <form role="form" method="POST" action="<?php echo base_url()."index.php/c_admin/do_update_admin"; ?>" >
                <div class="form-group">
                  <label>Id Admin</label>
                  <input class="form-control" name="id_admin" value="<?php echo $id_admin; ?>" placeholder="Enter text" readonly="true">
                </div>
                <div class="form-group">
                  <label>Username</label>
                  <input class="form-control" name="username_admin" value="<?php echo $username_admin; ?>" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <input class="form-control" name="password_admin" value="<?php echo $password_admin; ?>" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Nama</label>
                  <input class="form-control" name="nm_admin" value="<?php echo $nm_admin; ?>" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Kontak</label>
                  <input class="form-control" name="kontak_admin" value="<?php echo $kontak_admin; ?>" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Email</label>
                  <input class="form-control" name="email" value="<?php echo $email; ?>" placeholder="Enter text">
                </div>
                <div class="form-group">
                  <label>Alamat</label>
