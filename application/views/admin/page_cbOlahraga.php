                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                              ...
                              <label>
                               <a class="btn btn-primary" href="<?php echo base_url()."index.php/c_admin/add_cb_olahraga"; ?>">
                               Insert Data </a>
                              </label>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                           <tr class="odd gradeX"> <td><?php echo $keyPro['kd_cb_olahraga']; ?></td>
                                            <td><?php echo $keyPro['nm_cb_olahraga']; ?></td>
                                            <td align="left">
                                                <a class="btn btn-primary" href="<?php echo base_url()."index.php/c_admin/edit_cbOlahraga/".$keyPro['kd_cb_olahraga']; ?>">Edit</a> ||
                                                <a class="btn btn-primary" href="<?php echo base_url()."index.php/c_admin/do_delete_cb_olahraga/".$keyPro['kd_cb_olahraga']; ?>">Delete</a>
                                            </td>
                                        </tr>
