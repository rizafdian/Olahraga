                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                              ...
                              <label>
                               <a class="btn btn-primary" href="<?php echo base_url()."index.php/c_admin/add_pelatih"; ?>">
                               Insert Data </a>
                              </label>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                           <tr class="odd gradeX"> <td><?php echo $keyPro['id']; ?></td>
                                            <td><?php echo $keyPro['nm_pelatih']; ?></td>
                                            <td><?php echo $keyPro['tmpt_lhr']; ?></td>
                                            <td><?php echo $keyPro['tgl_lhr']; ?></td>
                                            <td><?php echo $keyPro['alamat']; ?></td>
                                            <td><?php echo $keyPro['kabupaten']; ?></td>
                                            <td><?php echo $keyPro['propinsi']; ?></td>
                                            <td><?php echo $keyPro['kontak']; ?></td>
                                            <td><?php echo $keyPro['username_pelatih']; ?></td>
                                            <td><?php echo $keyPro['password_pelatih']; ?></td>
                                            <td align="left">
                                                <a class="btn btn-primary" href="<?php echo base_url()."index.php/c_admin/edit_pelatih/".$keyPro['id']; ?>">Edit</a> ||
                                                <a class="btn btn-primary" href="<?php echo base_url()."index.php/c_admin/do_delete_pelatih/".$keyPro['id']; ?>">Delete</a>
                                            </td>
                                        </tr>
