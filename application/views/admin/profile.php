                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <tr><th>Nama</th><td><?php echo "$keyPro->nm_admin<br>" ; ?></td></tr>
                                    <tr><th>Alamat</th><td><?php echo "$keyPro->alamat<br>" ; ?></td></tr>
                                    <tr><th>Email</th><td><?php echo "$keyPro->email<br>" ; ?></td></tr>
                                    <tr><th>Kontak</th><td><?php echo "$keyPro->kontak_admin<br>" ; ?></td></tr>
                                    </table>
                        <?php  } ?>
                            </div>
                            <!-- /.table-responsive -->
