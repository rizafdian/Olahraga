    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Cabang Olahraga Atlit</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="http://localhost/olahraga/index.php/c_atlit/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr><th>Pekerjaan</th><td><?php echo "$keyPro->pekerjaan<br>" ; ?></td></tr>
                                    <tr><th>Kontak</th><td><?php echo "$keyPro->kontak<br>" ; ?></td></tr>
                                    <tr><th>Kejuaraan</th><td><?php echo "$keyPro->kejuaraan_ygdiikuti<br>" ; ?></td></tr>
                                    <tr><th>Hasil Kejuaraan</th><td><?php echo "$keyPro->hasil_kejuaraan<br>" ; ?></td></tr>
                                    <tr><th>Kekuatan</th><td><?php echo "$keyPro->kekuatan<br>" ; ?></td></tr>
                                    <tr><th>Kelenturan</th><td><?php echo "$keyPro->kelenturan<br>" ; ?></td></tr>
                                    <tr><th>Kecepatan</th><td><?php echo "$keyPro->kecepatan<br>" ; ?></td></tr>
                                    <tr><th>Reaksi</th><td><?php echo "$keyPro->reaksi<br>" ; ?></td></tr>
                                    <tr><th>Power</th><td><?php echo "$keyPro->power<br>" ; ?></td></tr>
                                    <tr><th>Daya Tahan Otot</th><td><?php echo "$keyPro->dayatahanotot<br>" ; ?></td></tr>
                                    <tr><th>V02max</th><td><?php echo "$keyPro->v02max<br>" ; ?></td></tr>
                                    <tr><th>Kelincahan</th><td><?php echo "$keyPro->kelincahan<br>" ; ?></td></tr>
                                    <tr><th>teknik</th><td><?php echo "$keyPro->teknik<br>" ; ?></td></tr>
                                    <tr><th>Kesehatan</th><td><?php echo "$keyPro->kesehatan<br>" ; ?></td></tr>
                                    <tr><th>Psikologi</th><td><?php echo "$keyPro->psikologi<br>" ; ?></td></tr>
                                </table>
                        <?php  } ?>
                            </div>
                            <!-- /.table-responsive -->
